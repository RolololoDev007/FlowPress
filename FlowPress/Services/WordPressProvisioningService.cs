    ...
    SupabaseService supabaseService)
{
    public async Task ProvisionAsync(Guid instanceId, string adminPassword, CancellationToken cancellationToken = default)
    {
        ...
        var remoteBasePath = $"/opt/flowpress/instances/{instance.Id}";
        var remoteComposePath = $"{remoteBasePath}/docker-compose.yml";
...
docker compose -f {QuoteForShell(remoteComposePath)} ps -a
""";
